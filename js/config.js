...
Game.Config = {
  ...
  ACTIVITIES: {
    ...
    plant_tomato: { label: 'Plant Tomato ($5)',  duration: 15,  needs: { fun: 5 },      room: 'garden',   furniture: 'garden_plot', targetState: 'crop_empty', icon: '🍅', skill: 'gardening', xp: 5, energyCost: 5, cost: 5 },
    plant_corn:   { label: 'Plant Corn ($15)',   duration: 15,  needs: { fun: 5 },      room: 'garden',   furniture: 'garden_plot', targetState: 'crop_empty', icon: '🌽', skill: 'gardening', xp: 8, energyCost: 8, cost: 15 },
    plant_pumpkin:{ label: 'Plant Pumpkin ($50)',duration: 15,  needs: { fun: 5 },      room: 'garden',   furniture: 'garden_plot', targetState: 'crop_empty', icon: '🎃', skill: 'gardening', xp: 15, energyCost: 15, cost: 50 },
    water_crop:   { label: 'Water Crop',         duration: 10,  needs: { fun: 2 },      room: 'garden',   furniture: 'garden_plot', targetState: 'crop_thirsty', icon: '💧', skill: 'gardening', xp: 5, energyCost: 2 },
    harvest_crop: { label: 'Harvest Crop',       duration: 20,  needs: { fun: 15 },     room: 'garden',   furniture: 'garden_plot', targetState: 'crop_ready', icon: '🌾', skill: 'gardening', xp: 20, moodlet: { name: 'Bountiful Harvest', value: 5, duration: 180, icon: '🥕' } },
    ...
    repair:        { label: 'Repair',         duration: 30, needs: {},                       room: null,      furniture: null, targetState: 'broken', icon: '🔧', skill: 'handiness', xp: 25, moodlet: { name: 'Handy', value: 4, duration: 120, icon: '🔧' } },
    ...
    travel:        { label: 'Travel',         duration: 1,  needs: {},                       room: '*',       furniture: 'map_portal', targetState: 'destination', icon: '🚶' },
    take_subway:   { label: 'Take Subway',    duration: 15, needs: { energy: 5 },            room: '*',       furniture: 'subway_gate', targetState: 'destination', icon: '🚇', cost: 5 },
    fill_bowl:     { label: 'Fill Pet Bowl',  duration: 10,  needs: { fun: 5 },              room: '*',       furniture: 'pet_bowl', targetState: 'bowl_empty', icon: '🐟', cost: 10, moodlet: { name: 'Caring Provider', value: 3, duration: 120, icon: '❤️' } },
